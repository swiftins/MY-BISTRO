...
# Загрузка данных
try:
#    load_data_from_csv('My_bistro/csv_for_import/users.csv', User)
#    load_data_from_csv('My_bistro/csv_for_import/categories.csv', Category)
#    load_data_from_csv('My_bistro/csv_for_import/dishes.csv', Dish)
    load_data_from_csv('My_bistro/csv_for_import/orders.csv', Order)
#    load_data_from_csv('My_bistro/csv_for_import/order_items.csv', OrderItem)
#    load_data_from_csv('My_bistro/csv_for_import/feedbacks.csv', Feedback)
